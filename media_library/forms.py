...
class SearchForm(forms.Form):
    ...
    def __init__(self, *args, filter_choices=None, **kwargs):
        ...
        common_input_class = (
            "w-full rounded-lg border border-white/10 bg-black/25 px-3 py-2 "
            "text-sm text-white outline-none transition placeholder:text-white/35 "
            "focus:border-[#eab308]/70 focus:ring-2 focus:ring-[#eab308]/20"
        )
        common_select_class = (
            "w-full rounded-lg border border-white/10 bg-black/25 px-3 py-2 "
            "text-sm text-white outline-none transition focus:border-[#eab308]/70 "
